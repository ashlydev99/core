...
If you have a Linux system you may install the ``nexuschat`` binary "wheel" packages
without any "build-from-source" steps.
Otherwise you need to `compile the Nexus Chat bindings yourself`__.
...
Then clone the deltachat-core-rust repo::
   ...
   git clone https://github.com/ashlydev99/core
   cd nexuschat-core-rust

To install the Nexus Chat Python bindings make sure you have Python3 installed.
...
`libnexuschat` library and `nexuschat.h` header are expected
