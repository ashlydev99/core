...
Nexus Chat developers and the CI system use a special URL to create
...
The `nexusbot repository <https://github.com/ashlydev99/nexusbot#nexuschat-example-bot>`_
contains a little framework for writing nexuschat bots in Python.
