...
def main():
    ...
    json_list = [
        "nexuschat-jsonrpc/typescript/package.json",
        "nexuschat-rpc-server/npm-package/package.json",
    ]
    toml_list = [
        "Cargo.toml",
        "nexuschat-ffi/Cargo.toml",
        "nexuschat-jsonrpc/Cargo.toml",
        "nexuschat-rpc-server/Cargo.toml",
        "nexuschat-repl/Cargo.toml",
        "python/pyproject.toml",
        "nexuschat-rpc-client/pyproject.toml",
    ]
    try:
    ...
    ffi_toml = read_toml_version("nexuschat-ffi/Cargo.toml")
