...
///
/// Also see https://github.com/nexuschat/nexuschat-core-rust/issues/3479.
...
///
/// ```
/// use nexuschat_contact_tools::EmailAddress;
...
mod tests {
    ...
    fn test_sanitize_bidi_characters() {
        // Legit inputs:
        assert_eq!(
            &sanitize_bidi_characters("Tes\u{2067}ting Nexus Chat\u{2069}"),
            "Tes\u{2067}ting Nexus Chat\u{2069}"
        );

        assert_eq!(
            &sanitize_bidi_characters("Tes\u{2067}ting \u{2068} Nexus Chat\u{2069}\u{2069}"),
            "Tes\u{2067}ting \u{2068} Nexus Chat\u{2069}\u{2069}"
        );

        assert_eq!(
            &sanitize_bidi_characters("Tes\u{2067}ting\u{2069} Nexus Chat\u{2067}\u{2069}"),
            "Tes\u{2067}ting\u{2069} Nexus Chat\u{2067}\u{2069}"
        );

        // Potentially-malicious inputs:
        assert_eq!(
            &sanitize_bidi_characters("Tes\u{202C}ting Nexus Chat"),
            "Testing Nexus Chat"
        );

        assert_eq!(
            &sanitize_bidi_characters("Testing Nexus Chat\u{2069}"),
            "Testing Nexus Chat"
        );

        assert_eq!(
            &sanitize_bidi_characters("Tes\u{2067}ting Nexus Chat"),
            "Testing Nexus Chat"
        );

        assert_eq!(
            &sanitize_bidi_characters("Tes\u{2069}ting Nexus Chat\u{2067}"),
            "Testing Nexus Chat"
        );

        assert_eq!(
            &sanitize_bidi_characters("Tes\u{2068}ting Nexus Chat"),
            "Testing Nexus Chat"
        );
    }
}
