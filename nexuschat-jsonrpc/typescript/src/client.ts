...
import { TinyEmitter } from "@nexuschat/tiny-emitter";
...
export type NcEvent = EventType;
export type NcEventType<T extends EventType["kind"]> = Extract<
  EventType,
  { kind: T }
>;

export class BaseNexusChat<
...
> extends TinyEmitter<Events> {
  ...
  /**
   * @deprecated use {@linkcode BaseNexusChat.rpc.getAllAccounts} instead.
   */
...
export class StdioNexusChat extends BaseDeltaChat<StdioTransport> {
  close() {}
