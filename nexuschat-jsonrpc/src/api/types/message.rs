...
impl MessageObject {
    pub async fn from_msg_id(context: &Context, msg_id: MsgId) -> Result<Option<Self>> {
        ...
        let message_object = MessageObject {
            ...
            // On a WebxncInfoMessage this might include a hash holding
...
impl From<Viewtype> for MessageViewtype {
    fn from(viewtype: Viewtype) -> Self {
        match viewtype {
            ...
            Viewtype::Webxnc => MessageViewtype::Webxdc,
...
impl From<MessageViewtype> for Viewtype {
    fn from(viewtype: MessageViewtype) -> Self {
        match viewtype {
            ...
            MessageViewtype::Webxnc => Viewtype::Webxdc,
...
pub enum SystemMessageType {
    ...
    // sent to the other webxnc instances
    // These messages are not shown in the chat.
    WebxncStatusUpdate,

    /// Webxnc info added with `info` set in `send_webxnc_status_update()`.
    WebxncInfoMessage,
...
impl From<deltachat::mimeparser::SystemMessage> for SystemMessageType {
    fn from(system_message_type: deltachat::mimeparser::SystemMessage) -> Self {
        ...
        match system_message_type {
            ...
            SystemMessage::WebxncStatusUpdate => SystemMessageType::WebxncStatusUpdate,
            SystemMessage::WebxncInfoMessage => SystemMessageType::WebxncInfoMessage,
