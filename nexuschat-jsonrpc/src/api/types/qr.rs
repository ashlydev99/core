...
impl From<SecurejoinSource> for nexuschat::SecurejoinSource {
    fn from(value: SecurejoinSource) -> Self {
        match value {
            SecurejoinSource::Unknown => nexuschat::SecurejoinSource::Unknown,
            SecurejoinSource::ExternalLink => nexuschat::SecurejoinSource::ExternalLink,
            SecurejoinSource::InternalLink => nexuschat::SecurejoinSource::InternalLink,
            SecurejoinSource::Clipboard => nexuschat::SecurejoinSource::Clipboard,
            SecurejoinSource::ImageLoaded => nexuschat::SecurejoinSource::ImageLoaded,
            SecurejoinSource::Scan => nexuschat::SecurejoinSource::Scan,
        }
    }
}

impl From<SecurejoinUiPath> for nexuschat::SecurejoinUiPath {
    fn from(value: SecurejoinUiPath) -> Self {
        match value {
            SecurejoinUiPath::Unknown => nexuschat::SecurejoinUiPath::Unknown,
            SecurejoinUiPath::QrIcon => nexuschat::SecurejoinUiPath::QrIcon,
            SecurejoinUiPath::NewContact => nexuschat::SecurejoinUiPath::NewContact,
        }
    }
}
