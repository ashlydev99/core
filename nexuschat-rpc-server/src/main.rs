...
use deltachat::constants::NC_VERSION_STR;
...
async fn main_impl() -> Result<()> {
    ...
    let path = std::env::var("NC_ACCOUNTS_PATH").unwrap_or_else(|_| "accounts".to_string());
