...
as seen by the device that sends the GMM. The `Spec <https://github.com/nexuschat/nexuschat-core-rust/blob/master/spec.md#add-and-remove-members>`_ details the Mime headers and format.
