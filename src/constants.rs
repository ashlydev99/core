...
use nexuschat_derive::{FromSql, ToSql};
use percent_encoding::{AsciiSet, NON_ALPHANUMERIC};
use serde::{Deserialize, Serialize};

use crate::chat::ChatId;

pub static NC_VERSION_STR: &str = env!("CARGO_PKG_VERSION");
...
pub const NC_HANDSHAKE_CONTINUE_NORMAL_PROCESSING: i32 = 0x01;
pub const NC_HANDSHAKE_STOP_NORMAL_PROCESSING: i32 = 0x02;
pub const NC_HANDSHAKE_ADD_DELETE_JOB: i32 = 0x04;

pub(crate) const NC_FROM_HANDSHAKE: i32 = 0x01;

pub const NC_GCL_ARCHIVED_ONLY: usize = 0x01;
pub const NC_GCL_NO_SPECIALS: usize = 0x02;
pub const NC_GCL_ADD_ALLDONE_HINT: usize = 0x04;
pub const NC_GCL_FOR_FORWARDING: usize = 0x08;

pub const NC_GCL_ADD_SELF: u32 = 0x02;
pub const NC_GCL_ADDRESS: u32 = 0x04;

// unchanged user avatars are resent to the recipients every some days
pub(crate) const NC_RESEND_USER_AVATAR_DAYS: i64 = 14;
...
pub(crate) const NC_OUTDATED_WARNING_DAYS: i64 = 183;

/// messages that should be deleted get this chat_id; the messages are deleted from the working thread later then. This is also needed as rfc724_mid should be preset as long as the message is not deleted on the server (otherwise it is downloaded again)
pub const NC_CHAT_ID_TRASH: ChatId = ChatId::new(3);
/// only an indicator in a chatlist
pub const NC_CHAT_ID_ARCHIVED_LINK: ChatId = ChatId::new(6);
/// only an indicator in a chatlist
pub const NC_CHAT_ID_ALLDONE_HINT: ChatId = ChatId::new(7);
/// larger chat IDs are "real" chats, their messages are "real" messages.
pub const NC_CHAT_ID_LAST_SPECIAL: ChatId = ChatId::new(9);
...
pub const NC_DESIRED_TEXT_LEN: usize = NC_DESIRED_TEXT_LINE_LEN * NC_DESIRED_TEXT_LINES;
...
/// Before calling configure() with NC_LP_AUTH_OAUTH2 set,
/// the user has to confirm access at the URL returned by dc_get_oauth2_url().
pub const NC_LP_AUTH_OAUTH2: i32 = 0x2;

/// Force NORMAL authorization, this is the default.
/// If this flag is set, automatic configuration is skipped.
pub const NC_LP_AUTH_NORMAL: i32 = 0x4;

/// if none of these flags are set, the default is chosen
pub const NC_LP_AUTH_FLAGS: i32 = NC_LP_AUTH_OAUTH2 | NC_LP_AUTH_NORMAL;
...
pub(crate) const NC_FOLDERS_CONFIGURED_KEY: &str = "folders_configured";
// this value can be increased if the folder configuration is changed and must be redone on next program start
pub(crate) const NC_FOLDERS_CONFIGURED_VERSION: i32 = 5;
...
pub(crate) const NC_BACKGROUND_FETCH_QUOTA_CHECK_RATELIMIT: u64 = 12 * 60 * 60; // 12 hours
...
// To make text edits clearer for Non-nexus-MUA or old nexus Chats, edited text will be prefixed by EDITED_PREFIX.
// Newer nexus Chats will remove the prefix as needed.
pub(crate) const EDITED_PREFIX: &str = "✏️";

/// Period between `sql::housekeeping()` runs.
pub(crate) const HOUSEKEEPING_PERIOD: i64 = 24 * 60 * 60;

pub(crate) const BROANCAST_INCOMPATIBILITY_MSG: &str = r#"The up to now "experimental channels feature" is about to become an officially supported one. By that, privacy will be improved, it will become faster, and less traffic will be consumed.
...
If you have any questions, please send an email to nexus@merlinux.eu or ask at https://support.nexus.chat/."#;
