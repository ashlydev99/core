...
use crate::constants::{NC_LP_AUTH_FLAGS, NC_LP_AUTH_OAUTH2};
...
pub(crate) enum ConfiguredCertificateChecks {
    ...
    ///
    /// Previous Nexus Chat versions before core 1.133.0
...
impl ConfiguredLoginParam {
    ...
    pub(crate) async fn load_legacy(context: &Context) -> Result<Option<Self>> {
        ...
        let server_flags = context
            ...
            .await?
            .unwrap_or_default();
        let oauth2 = matches!(server_flags & NC_LP_AUTH_FLAGS, DC_LP_AUTH_OAUTH2);
