//! [Provider database](https://providers.nexus.chat/) module.
...
#[repr(u8)]
pub enum Status {
    /// Provider is known to be working with Nexus Chat.
    Ok = 1,

    /// Provider works with Nexus Chat, but requires some preparation,
    /// such as changing the settings in the web interface.
    Preparation = 2,

    /// Provider is known not to work with Nexus Chat.
    Broken = 3,
}
