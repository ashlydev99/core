...
/// numbers must stay in sync with `nexuschat.h` `DC_STR_*` constants.
///
...
pub enum StockMessage {
    ...
    #[strum(props(
        fallback = "Messages in this chat are generated locally by your Nexus Chat app. \
    ...
    #[strum(props(fallback = "⚠️ Your Nexus Chat version might be outdated.\n\n\
                    This may cause problems because your chat partners use newer versions - \
                    and you are missing the latest features 😳\n\
                    Please check https://get.nexus.chat or your app store for updates."))]
    ...
    #[strum(props(
        fallback = "This message is used to synchronize data between your devices.\n\n\
                    👉 If you see this message in Nexus Chat, please update your Nexus Chat apps on all devices."
    ))]
    SyncMsgBody = 102,
    ...
    #[strum(props(fallback = "❤️ Seems you're enjoying Nexus Chat!

Please consider donating to help that Nexus Chat stays free for everyone.

While Nexus Chat is free to use and open source, development costs money.
Help keeping us to keep Nexus Chat independent and make it more awesome in the future.

https://nexus.chat/donate"))]
    DonationRequest = 193,
    ...
    #[strum(props(
        fallback = "The attachment contains anonymous usage statistics, which helps us improve Nexus Chat. Thank you!"
    ))]
    StatsMsgBody = 210,
    ...
    #[strum(props(
        fallback = "You are using the legacy option \"Settings → Advanced → Move automatically to NexusChat Folder\".\n\nThis option will be removed in a few weeks and you should disable it already today.\n\nIf having chat messages mixed into your inbox is a problem, see https://nexus.chat/legacy-move"
    ))]
...
/// Stock string: `❤️ Seems you're enjoying Nexus Chat!`…
...
/// Stock string: `Welcome to Nexus Chat! – ...`.
...
/// Stock string: `⚠️ Your Nexus Chat version might be outdated...`.
...
/// Stock string: `The attachment contains anonymous usage statistics, which helps us improve Nexus Chat. Thank you!`
...
/// Stock string: `You are using the legacy option "Move automatically to NexusChat Folder`…
