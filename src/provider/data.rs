...
static P_163: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/163",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_AKTIVIX_ORG: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/aktivix-org",
    server: &[
        Server {
            protocol: Imap,
            socket: Starttls,
...
static P_ALIYUN: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/aliyun",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_AOL: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/aol",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_ARCOR_DE: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/arcor-de",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_AUTISTICI_ORG: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/autistici-org",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
// blindzeln.org.md: nexus.blinzeln.de, nexus.blindzeln.org
static P_BLINDZELN_ORG: Provider = Provider {
    id: "blindzeln.org",
    status: Status::Ok,
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/blindzeln-org",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_BLUEWIN_CH: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/bluewin-ch",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_BUZON_UY: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/buzon-uy",
    server: &[
        Server {
            protocol: Imap,
            socket: Starttls,
...
static P_CHELLO_AT: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/chello-at",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_COMCAST: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/comcast",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_DALETH_CAFE: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/daleth-cafe",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_DISMAIL_DE: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/dismail-de",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_DISROOT: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/disroot",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_E_EMAIL: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/e-email",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_ESPIV_NET: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/espiv-net",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_EXAMPLE_COM: Provider = Provider {
    ...
    after_login_hint: "This provider doesn't really exist, so you can't use it :/ If you need an email provider, take a look at providers.nexus.chat!",
    overview_page: "https://providers.nexus.chat/example-com",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_FASTMAIL: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/fastmail",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_FIREMAIL_DE: Provider = Provider {
    ...
    overview_page: "https://providers.nexus.chat/firemail-de",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_FIVE_CHAT: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/five-chat",
    server: &[],
    opt: ProviderOptions::new(),
...
static P_FREENET_DE: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/freenet-de",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_GMAIL: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/gmail",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_GMX_NET: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/gmx-net",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_HERMES_RADIO: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/hermes-radio",
    server: &[],
    opt: ProviderOptions {
        strict_tls: false,
        ..ProviderOptions::new()
...
static P_HEY_COM: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/hey-com",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_I_UA: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/i-ua",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_I3_NET: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/i3-net",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_ICLOUD: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/icloud",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_INFOMANIAK_COM: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/infomaniak-com",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_KOLST_COM: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/kolst-com",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_KONTENT_COM: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/kontent-com",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_MAIL_COM: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/mail-com",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_MAIL_DE: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/mail-de",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_MAIL_RU: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/mail-ru",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_MAIL2TOR: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/mail2tor",
    server: &[
        Server {
            protocol: Imap,
            socket: Plain,
...
static P_MAILBOX_ORG: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/mailbox-org",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_MAILO_COM: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/mailo-com",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_MEHL_CLOUD: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/mehl-cloud",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_MEHL_STORE: Provider = Provider {
    ...
    overview_page: "https://providers.nexus.chat/mehl-store",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_MIGADU: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/migadu",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_NAUTA_CU: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/nauta-cu",
    server: &[
        Server {
            protocol: Imap,
            socket: Starttls,
...
static P_NAVER: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/naver",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_NINE_TESTRUN_ORG: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/nine-testrun-org",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_NUBO_COOP: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/nubo-coop",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_OUTLOOK_COM: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/outlook-com",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_OUVATON_COOP: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/ouvaton-coop",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_POSTEO: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/posteo",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_PROTONMAIL: Provider = Provider {
    ...
    overview_page: "https://providers.nexus.chat/protonmail",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_PURELYMAIL_COM: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/purelymail-com",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_QQ: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/qq",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_RAMBLER_RU: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/rambler-ru",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_RISEUP_NET: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/riseup-net",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_ROGERS_COM: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/rogers-com",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_SONIC: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/sonic",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_STINPRIZA_NET: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/stinpriza-net",
    server: &[
        Server {
            protocol: Imap,
            socket: Starttls,
...
static P_SYSTEMAUSFALL_ORG: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/systemausfall-org",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_SYSTEMLI_ORG: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/systemli-org",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_T_ONLINE: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/t-online",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_TESTRUN: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/testrun",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_TISCALI_IT: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/tiscali-it",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_TUTANOTA: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/tutanota",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_UKR_NET: Provider = Provider {
    ...
    before_login_hint: "You must allow IMAP access to your account before you can login.",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/ukr-net",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_UNDERNET_UY: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/undernet-uy",
    server: &[
        Server {
            protocol: Imap,
            socket: Starttls,
...
static P_VFEMAIL: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/vfemail",
    server: &[],
    opt: ProviderOptions::new(),
    config_defaults: None,
    oauth2_authorizer: None,
...
static P_VIVALDI: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/vivaldi",
    server: &[
        Server {
            protocol: Imap,
            socket: Starttls,
...
static P_VK_COM: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/vk-com",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_VODAFONE_DE: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/vodafone-de",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_WEB_DE: Provider = Provider {
    ...
    overview_page: "https://providers.nexus.chat/web-de",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_WKPB_DE: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/wkpb-de",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_YAHOO: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/yahoo",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_YANDEX_RU: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/yandex-ru",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_YGGMAIL: Provider = Provider {
    ...
    overview_page: "https://providers.nexus.chat/yggmail",
    server: &[
        Server {
            protocol: Imap,
            socket: Plain,
...
static P_ZIGGO_NL: Provider = Provider {
    ...
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/ziggo-nl",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
static P_ZOHO: Provider = Provider {
    ...
    after_login_hint: "",
    overview_page: "https://providers.nexus.chat/zoho",
    server: &[
        Server {
            protocol: Imap,
            socket: Ssl,
...
pub(crate) static PROVIDER_DATA: [(&str, &Provider); 534] = [
    ...
    ("nexus.blinzeln.de", &P_BLINDZELN_ORG),
    ("nexus.blindzeln.org", &P_BLINDZELN_ORG),
