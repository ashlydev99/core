...
class EventType(str, Enum):
    ...
    WEBXNC_STATUS_UPDATE = "WebxncStatusUpdate"
    WEBXNC_INSTANCE_DELETED = "WebxncInstanceDeleted"
    ...
    WEBXNC_REALTIME_DATA = "WebxncRealtimeData"
    WEBXNC_REALTIME_ADVERTISEMENT_RECEIVED = "WebxncRealtimeAdvertisementReceived"
